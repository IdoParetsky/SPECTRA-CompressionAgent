...
def vgg8(num_classes):
    ...
    """
    model = VGG(cfg['S'], num_classes)
    return model


def vgg8_bn(num_classes):
    """VGG 8-layer model (configuration "S")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
...
def vgg11(num_classes):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(cfg['A'], num_classes)
    return model


def vgg11_bn(num_classes):
    """VGG 11-layer model (configuration "A") with batch normalization"""
    model = VGG(cfg['A'], batch_norm=True, num_classes=num_classes)
    return model
...
def vgg16(num_classes):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(cfg['D'], num_classes=num_classes)
    return model


def vgg16_bn(num_classes):
    """VGG 16-layer model (configuration "D") with batch normalization"""
    model = VGG(cfg['D'], batch_norm=True, num_classes=num_classes)
    return model
